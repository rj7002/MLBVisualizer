...
if formatted_date:
    ...
    if not df.empty:
        ...
        if filterby == 'Pitcher':
            ...
            selectp = st.selectbox('Select a player',unique_names_list)
        ...
        stl_file_path = f'/Users/ryan/Downloads/ImageToStl.com_a97cc114677c453abd44ba241b899b11/stadium_{hometeam}.stl'
        ...
        for i in range(len(x_coords)):
            ...
            if 'homer' in des.lower():
                height_scaling_factor = 1.25 # Adjust this factor to change how launch angle affects height
            else:
